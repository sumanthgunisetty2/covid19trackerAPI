...
import covidLogo from './Logo/covid1.png';


const pages = ['Homepage', 'Login', 'Registration', 'Profile','Cases','Covid'];
    ...
    <AppBar position="static">
      <Container maxWidth="xl" sx={{ backgroundColor: 'lightblue' }}>
        <Toolbar disableGutters>
          <Typography>
             <img src={covidLogo} alt="Covid Logo" style={{ width: '30px', marginRight: '10px' }} />
          </Typography>
